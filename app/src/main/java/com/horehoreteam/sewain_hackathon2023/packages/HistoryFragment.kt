...
import com.horehoreteam.sewain_hackathon2023.databinding.FragmentHistoryBinding
import com.horehoreteam.sewain_hackathon2023.databinding.FragmentRequestBinding
import com.horehoreteam.sewain_hackathon2023.packages.adapter.HistoryAdapter
...
class HistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listHistory = DataDummy.generateHistoryPacket()
        val adapter = RequestPacketStatusAdapter(listHistory)
        binding.apply {
